...
abstract class WMservicesController extends GetxController {
  getnewserviceorders();
}

class WMservicesControllerImp extends WMservicesController {
  ...
  getnewserviceorders() async {
    ...
    update();
    var response = await servicesdata.newwmservice();
