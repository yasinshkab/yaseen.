...
class InProgressOrderDetails extends StatelessWidget {
  ...
  InProgressOrderDetails({super.key});
                    ...
                    builder: (controller) => HandelOrderDetailsdataview(
                          ...
                          widget: Container(
                            ...
                            child: theneworderdetails(
                              ...
                              address:
                                  '${controller.ordersModel.addressCity},${controller.ordersModel.addressRegion},${controller.ordersModel.addressNote}',
                              // theimage: "${orderDetails[c]['image']}",
                              thewidth: MediaQuery.of(context).size.width * 1,
                              count: controller.orderdetails.length,
                              quantity: '00', name: '00', productprice: '00',
                            ),
                          ),
                        )),
                SizedBox(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Spacer(),
                        approve(onPressed: onpressed, title: buttontitle)
                      ],
                    ),
                  ],
                )),
