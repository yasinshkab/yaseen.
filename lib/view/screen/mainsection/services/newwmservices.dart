...
class WMServices extends StatelessWidget {
  const WMServices({super.key});

  @override
  Widget build(BuildContext context) {
    WMservicesControllerImp control = Get.put(WMservicesControllerImp());
    return Center(
        child: GetBuilder<WMservicesControllerImp>(
